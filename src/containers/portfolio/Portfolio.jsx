    ...
    <div className='thoth__blog section__padding' id="portfolio">
      ...
      <div className="thoth__blog-container">
        <div className="thoth__portfolio_groupB">
          ...
          <Article imgUrl={utopia} url="https://crypto-utopia.vercel.app" text="Crypto Website deployed and hosted on Vercel"date="June 21, 2022" title="Utopia"/>
          <Article imgUrl={thoth} text="Thoth made in React and hosted on Firebase"date="Sept 16, 2021" title="Punks Clone" url="https://thothio.firebaseapp.com/" />
        </div>
      </div>
